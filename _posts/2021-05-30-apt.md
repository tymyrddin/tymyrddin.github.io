...
2020 saw the rise of new attack vectors, such as the targeting of network appliances and the search for 5G vulnerabilities, alongside multi-stage attacks and activities enabling attacks, such as [credential stuffing](https://github.com/tymyrddin/orchard/blob/main/trees/social-engineering/Credential-stuffing.md). Most likely effects:
