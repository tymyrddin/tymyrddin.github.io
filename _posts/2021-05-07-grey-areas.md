...
And when the FLoC data set is big enough, [deanonymisation will become easy](https://tymyrddin.gitbook.io/orchard/terraforming-threat-modelling/de-anonymisation-threat-modelling). For example, cohorts of users sharing the same location data, shop in the same neighbourhood, are active in the same time zone, [can be easily be grouped together](https://tymyrddin.gitbook.io/orchard/terraforming-threat-modelling/de-anonymisation-threat-modelling/attack-vectors/classification-analysis) by demographics, and if the data is combined with other tracking mechanisms such as social media analytics or data sets purchased from [data brokers](https://tymyrddin.gitbook.io/orchard/terraforming-threat-modelling/de-anonymisation-threat-modelling/adversaries/data-brokers), fingerprinting users based on age, class, ethnicity, political parties becomes trivial.
...
Not entirely, because [users](https://tymyrddin.gitbook.io/orchard/munching-galaxies/data-protection-aka-infosec/safer-browsing/floc) and [webserver adminstrators and webmasters](https://tymyrddin.gitbook.io/orchard/munching-galaxies/data-protection-aka-infosec/web-applications/floced-sites) can jump through hoops, again. 
